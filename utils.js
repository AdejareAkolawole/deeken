function getProducts() {
  return JSON.parse(localStorage.getItem('products')) || [
    { id: 1, name: 'Smartphone X1', price: 299.99, image: 'https://via.placeholder.com/150?text=Smartphone_X1', category: 'electronics', description: 'High-performance smartphone with OLED display.', rating: 4.5 },
    { id: 2, name: 'T-Shirt Classic', price: 19.99, image: 'https://via.placeholder.com/150?text=TShirt_Classic', category: 'fashion', description: 'Comfortable cotton t-shirt.', rating: 4.0 },
    { id: 3, name: 'Wireless Earbuds', price: 59.99, image: 'https://via.placeholder.com/150?text=Wireless_Earbuds', category: 'electronics', description: 'True wireless earbuds with noise cancellation.', rating: 4.2 },
    { id: 4, name: 'Denim Jacket', price: 49.99, image: 'https://via.placeholder.com/150?text=Denim_Jacket', category: 'fashion', description: 'Stylish denim jacket for all seasons.', rating: 4.3 },
    { id: 5, name: 'Smartwatch Pro', price: 199.99, image: 'https://via.placeholder.com/150?text=Smartwatch_Pro', category: 'electronics', description: 'Fitness tracker with heart rate monitor.', rating: 4.7 },
    { id: 6, name: 'Sneakers Air', price: 79.99, image: 'https://via.placeholder.com/150?text=Sneakers_Air', category: 'fashion', description: 'Lightweight and breathable sneakers.', rating: 4.4 },
    { id: 7, name: 'Laptop Ultra', price: 999.99, image: 'https://via.placeholder.com/150?text=Laptop_Ultra', category: 'electronics', description: 'High-performance laptop for professionals.', rating: 4.8 },
    { id: 8, name: 'Sunglasses Retro', price: 29.99, image: 'https://via.placeholder.com/150?text=Sunglasses_Retro', category: 'fashion', description: 'Vintage-style sunglasses.', rating: 4.1 },
    { id: 9, name: 'Bluetooth Speaker', price: 39.99, image: 'https://via.placeholder.com/150?text=Bluetooth_Speaker', category: 'electronics', description: 'Portable speaker with deep bass.', rating: 4.3 },
